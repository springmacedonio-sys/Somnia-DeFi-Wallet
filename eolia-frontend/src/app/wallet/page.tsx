...
export default function Wallet() {
  ...
  return (
    <main style={{ backgroundImage: `url(bg.png)` }} className="bg-no-repeat bg-cover bg-center relative flex flex-col items-center h-screen w-screen gap-10 bg-[#f4f4fd] overflow-hidden font-sfpro">
